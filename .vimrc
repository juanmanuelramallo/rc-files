...
" virtual empty lines at end of file
set scrolloff=10
...
" Reveal the open file in NERDTree when opening the file.
" autocmd BufReadPost * NERDTreeFind | exe 'norm! \<C-w>p'
...
nmap <leader>tf :terminal rspec %<CR>
